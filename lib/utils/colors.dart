...
//
  ...
  //main color
  static Color lightAccentColor = const Color(0xff00B2CC);
  //text color
  ...
  static Color splashScreenGradientTopColor = const Color(0xffFFFFFF);
  static Color splashScreenGradientBottomColor = const Color(0xffFFFFFF);
