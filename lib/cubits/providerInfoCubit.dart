...
class ProviderDetailsState {
  ...
  ProviderDetailsState copyWith({
    ...
    return ProviderDetailsState(
      ProviderDetails(
        locationInformation: locationInformation ?? providerDetails.locationInformation,
        user: userDetails ?? providerDetails.user,
        providerInformation: providerInformation ?? providerDetails.providerInformation,
        bankInformation: bankInformation ?? providerDetails.bankInformation,
        workingDays: workingDays ?? providerDetails.workingDays,
        subscriptionInformation: subscriptionInformation ?? providerDetails.subscriptionInformation,
      ),
    );
  }
}
...
class ProviderDetailsCubit extends Cubit<ProviderDetailsState> {
  ProviderDetailsCubit() : super(ProviderDetailsState(ProviderDetails.createEmptyModel()));
  ...
  void updateProviderDetails({
    ...
    final ProviderDetails providerDetails = ProviderDetails(
      locationInformation: locationInformation ?? state.providerDetails.locationInformation,
      user: userDetails ?? state.providerDetails.user,
      providerInformation: providerInformation ?? state.providerDetails.providerInformation,
      ...
      subscriptionInformation:
          subscriptionInformation ?? state.providerDetails.subscriptionInformation,
    );
  ...
  List<String> getSubscribedCategories() {
    ...
    categoriesId.addAll(state.providerDetails.providerInformation!.customJobCategories!);
