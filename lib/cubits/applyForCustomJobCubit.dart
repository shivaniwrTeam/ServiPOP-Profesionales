...
class ApplyForCustomJobCubit extends Cubit<ApplyForCustomJobCubitState> {
  ...
  Future<void> applyForCustomJob(String? id, String? counterPrice,
      String? coverNote, String? duration, String? taxId) async {
    try {
      ...
      //
      emit(ApplyForCustomJobSuccess(
          error: response['error'].toString(), message: message));
    } catch (e) {
