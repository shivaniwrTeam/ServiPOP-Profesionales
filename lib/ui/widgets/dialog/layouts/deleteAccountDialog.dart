  ...
  Widget build(BuildContext context) {
    return BlocConsumer<SignInCubit, SignInState>(
      ...
      builder: (context, signInState) {
        ...
        return BlocConsumer<DeleteProviderAccountCubit,
            DeleteProviderAccountState>(
          listener: (final BuildContext context,
              final DeleteProviderAccountState state) async {
          ...
          builder: (final BuildContext context,
            ...
            showProgress = state is DeleteProviderAccountInProgress ||
                ...
                child: CustomTextFormField(
                  ...
                  validator: (password) {
                    if (password == null || password.trim().isEmpty) {
                      return "pleaseEnterPassword".translate(context: context);
                    }
