...
class AdditionalChargesBottomSheet extends StatefulWidget {
  const AdditionalChargesBottomSheet({
    super.key,
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
                      ...
                      children: [
                        Expanded(
                          child: CustomTextFormField(
                            labelText:
                                'serviceName'.translate(context: context),
                        ...
                        Expanded(
                          child: CustomTextFormField(
                            labelText:
                                'chargeAmount'.translate(context: context),
            ...
            const CustomSizedBox(height: 15), // Space before bottom buttons
