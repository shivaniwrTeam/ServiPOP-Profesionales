...
class CategoriesState extends State<Categories> {
  ...
  late List<String> selectedCategoryIds =
      context.read<ProviderDetailsCubit>().getSubscribedCategories();
  ...
  Widget build(BuildContext context) {
    return PopScope(
      canPop: context.watch<ManageCategoryPreferenceCubit>().state
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            leading: CustomBackArrow(
              canGoBack: context.watch<ManageCategoryPreferenceCubit>().state
                  is! ManageCategoryPreferenceInProgress,
            ),
          ),
  ...
  Widget bottomBarWidget() {
    return BlocConsumer<ManageCategoryPreferenceCubit,
        ManageCategoryPreferenceState>(
      listener: (context, state) {
        if (state is ManageCategoryPreferenceFailure) {
          UiUtils.showMessage(
            context,
            'selectCategory'.translate(context: context),
          ...
          UiUtils.showMessage(
            context,
            'categoryUpdated'.translate(context: context),
