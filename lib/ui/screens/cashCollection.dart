                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return CustomContainer(
                      ...
                      boxShadow: [
                        BoxShadow(
                          color:
                              context.colorScheme.secondaryColor.withAlpha(50),
                            ...
                            children: [
                              ...
                              cashCollectionData[index].orderID == ''
                                  ? CustomText(
                                      ...
                                      color: cashCollectionData[index]
                                                  .status!
                                                  .trim()
                                                  .capitalize() ==
                                              'Paid'
      ...
      children: [
        CustomRefreshIndicator(
          ...
          child: (selectedFilter == 'paid')
              ? BlocConsumer<AdminCollectCashCollectionHistoryCubit,
