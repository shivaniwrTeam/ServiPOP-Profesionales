        ...
        children: [
          ...
          if (context
            ...
            _buildGridItem(
                ...
                allowNotAllowFilter[widget.service.isPayLaterAllowed!]!
                    .translate(context: context),
                context.colorScheme.blackColor),
          _buildGridItem(
              ...
              widget.service.cancelableTill! == '' ||
                  ...
                  ? allowNotAllowFilter[widget.service.isCancelable!]!
                      .translate(context: context)
                  : "${widget.service.cancelableTill!} ${"minutes".translate(context: context)}",
              context.colorScheme.blackColor),
          _buildGridItem(
              'serviceAtStore'.translate(context: context),
              allowNotAllowFilter[widget.service.isStoreAllowed!]!
                  .translate(context: context),
              context.colorScheme.blackColor),
          _buildGridItem(
              'serviceAtDoorstep'.translate(context: context),
              allowNotAllowFilter[widget.service.isDoorStepAllowed!]!
                  .translate(context: context),
              context.colorScheme.blackColor),
        ],
      ),
