...
class ReviewsScreenState extends State<ReviewsScreen>
            ...
            Column(
              ...
              children: [
                setLinearProgressIndicator(
                    semanticLbl: '5star', progressVal: fiveStarPercentage),
                setLinearProgressIndicator(
                    semanticLbl: '4star', progressVal: fourStarPercentage),
                setLinearProgressIndicator(
                    semanticLbl: '3star', progressVal: threeStarPercentage),
                setLinearProgressIndicator(
                    semanticLbl: '2star', progressVal: twoStarPercentage),
                setLinearProgressIndicator(
                  semanticLbl: '1star',
  ...
  Widget setLinearProgressIndicator({
    ...
    valueColor ??=
        AlwaysStoppedAnimation<Color>(context.colorScheme.accentColor);
    return SizedBox(
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  CustomText(
                    (model.ratedOn ?? "").formatDateAndTime(),
                    fontSize: 10,
                    color: Theme.of(context).colorScheme.lightGreyColor,
                  ),
                ],
