        ...
        onNavigationRequest: (final request) {
          if (request.url.startsWith("${baseUrl}app_payment_status") ||
              ...
              request.url.startsWith(
                  '${context.read<FetchSystemSettingsCubit>().getPaymentMethodSettings().flutterwaveWebsiteUrl}/payment-status') ||
              request.url.startsWith(
                  '${context.read<FetchSystemSettingsCubit>().getPaymentMethodSettings().paypalWebsiteUrl}/payment-status')) {
